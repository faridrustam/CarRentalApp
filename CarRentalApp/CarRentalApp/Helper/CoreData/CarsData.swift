...
class CarsData {
    ...
    func loadData() {
        ...
        let standardCar2 = CarModel(category: standardCategory, carName: "Toyota", carModel: "Prius", engine: "2-Cyl 4.0 Liter", price: "250$", image: "standard")
        carData.saveData(carModel: standardCar2)
        
        let standardCar3 = CarModel(category: standardCategory, carName: "Toyota", carModel: "Avanza", engine: "2-Cyl 3.0 Liter", price: "200$", image: "standard")
        ...
        let suvCar1 = CarModel(category: suvCategory, carName: "Hyundai", carModel: "Tucson", engine: "4-Cyl 1.5 Liter", price: "450$", image: "suv")
